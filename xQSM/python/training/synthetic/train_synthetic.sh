...
#$ -N Aug20_xQSM_Synthetic_Train_lr4e-4_ps48_ep100_bs80
...
--ckpt_folder "xQSM_synthetic_bs80_ep100_lr4e-4_ps48" \
...
# --data_directory "/Users/sirbucks/Documents/xQSM/simulated_volumes_nifti" \
# --snapshot_path "/Users/sirbucks/Documents/xQSM/xQSM/python/training/synthetic/ckpt/" \
# --ckpt_folder "xQSM_synthetic_bs80_ep100_lr4e-4_ps48" \
# --learning_rate 0.0004 \
# --batch_size 80 \
# --epochs 100 \
